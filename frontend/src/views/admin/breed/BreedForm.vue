<template>
  <div class="card shadow-lg border-0 mb-4 animate__animated animate__fadeIn">
    <div
      class="card-header bg-primary text-white font-weight-bold py-3 d-flex justify-content-between align-items-center"
    >
      <span>
      ...
      <span class="badge badge-light text-primary">
        Mã giống: {{ breed.maGiong || "Tự động" }}
      </span>
    </div>
    ...
    <div class="card-body p-4">
      <form @submit.prevent="submitForm">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group mb-3">
              <label class="font-weight-bold text-success">
                <i class="fas fa-pencil-alt"></i> Mô tả đặc điểm:
              </label>
              <textarea
                ...
                style="border-radius: 12px; resize: none; background-color: #f9fff9;"
              ></textarea>
            </div>
            ...
            <div class="form-group mb-3">
              ...
              <div class="custom-file mb-2">
                <input
                  ...
                  ref="fileInput"
                />
                <label class="custom-file-label border-success" for="breedImage">
                  {{ fileName || "Chọn ảnh giống chó..." }}
                </label>
              </div>

              <div v-if="imageSource" class="image-preview-container mt-2">
        ...
        <div class="text-center border-top pt-4 mt-3">
          <button
            type="button"
            class="btn btn-secondary mr-3 px-4 shadow-sm"
            @click="$emit('cancel')"
          >
            HỦY BỎ
          </button>
