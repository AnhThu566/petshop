      ...
      <table class="table table-hover mb-0 text-center align-middle">
        ...
        <tbody>
          <tr v-for="(item, index) in filteredBreeds" :key="item._id || item.id">
            ...
            <td class="align-middle">
              <span v-if="item.status === 'active'" class="badge badge-success p-2">
                Đang kinh doanh
              </span>
              <span v-else-if="item.status === 'paused'" class="badge badge-warning p-2">
                Tạm ngưng
              </span>
              <span v-else class="badge badge-secondary p-2">
                Ngừng kinh doanh
              </span>
            </td>
