    ...
    <div class="container-fluid px-2">
      <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3 flex-wrap">
        <div>
          ...
          <div class="small text-muted">
            Quản lý danh mục loại dịch vụ, trạng thái hoạt động và thông tin mô tả.
          </div>
        </div>
      ...
      <div class="card border-0 shadow-sm" v-if="filteredCategories.length > 0">
        <div class="table-responsive">
          <table class="table table-hover align-middle text-center mb-0 service-category-table">
            <thead class="bg-light">
              <tr class="small text-secondary">
                <th class="py-3 text-center col-code">Mã loại</th>
                <th class="py-3 text-left col-name">Tên loại dịch vụ</th>
            ...
            <div class="modal-body order-detail-body">
              <div class="detail-card">
                <div class="detail-row">
                  <span>Mã loại</span>
                  <strong>{{ selectedCategory.categoryCode || '---' }}</strong>
                </div>
                <div class="detail-row">
                  <span>Tên loại</span>
      ...
      <div
        v-if="showFormModal || selectedCategory"
...
.service-category-table thead th {
  font-weight: 700;
  white-space: nowrap;
}
